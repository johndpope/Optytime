...
//  /***************************/
//
//  Redesigned and updated by Alexey Khan on 04/03/2014.
//
//  /***************************/
//
...
#define MAX_TOGGLE_DURATION 0.15
...
{   
    ...
    switch (_type)
    {
        ...
        case iCarouselTypeInvertedRotary:
        {
            ...
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.2f]; //1.0 with 30 параллельных показов
